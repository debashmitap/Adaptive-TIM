...
2. To generate the realizations on the nethept dataset, run ./realizations.sh nethept (no. of realizations). (Eg. ./realizations.sh nethept 50 for 50 realizations)
